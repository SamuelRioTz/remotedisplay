// Regla "siempre por 1x": create(hidpi) = 1x -> Retina; resize(hidpi) = 1x nuevo -> Retina.
...
int main() { @autoreleasepool {
    active("inicio");
    uint32_t a = MacCreateVirtualDisplay(642, 351, 60, true, "RD retina"); sleep(2); info("creado hidpi 642x351", a);
    ...
    MacDestroyVirtualDisplay(a); sleep(8); active("tras destruir +8s");
    return 0;
} }
